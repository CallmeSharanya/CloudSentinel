import pandas as pd
import json
from HE_and_Stego.PHEops import *
from HE_and_Stego.stego_encrypt import encode_json_rows_into_images
from HE_and_Stego.stego_decrypt import decrypt_stego_image
...
def encrypt_HE_and_stego(public_key, excel_file, images_directory, encoded_imgs_directory):
    ...
    return encode_json_rows_into_images(encrypted_json_data, images_directory, encoded_imgs_directory)
...
if __name__ == "__main__":
    ...
    encoded_user_img = r"C:\RVCE\College_SEM3\SEM 3 EL\Trials\flask-s3-file-upload\encoded_imgs\image_ratna.png"
